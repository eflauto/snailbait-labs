...
/*
We want to draw the background in different locations (plural) on the canvas. To fulfill this requirement, I'm going
to make it randomly pick where to draw the canvas every reload. - EF
*/
function drawBackground() {
   let xPos = Math.random() * 800;
   let yPos = Math.random() * 400;

   context.drawImage(background, xPos, yPos);
}
