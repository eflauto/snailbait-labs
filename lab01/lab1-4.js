...
/*
Literally all we do is reorder this so that drawRunner() is first. This has the effect of making the runner invisible
because it is drawn behind the background. - EF
*/
