var SnailBait = function () {
    ...
    this.runnerCellsRight = [
        {
            left: 471, top: 391, width: this.RUNNER_CELLS_WIDTH,
            height: this.RUNNER_CELLS_HEIGHT
        },
        {
            left: 521, top: 391, width: this.RUNNER_CELLS_WIDTH,
            height: this.RUNNER_CELLS_HEIGHT
        },
        {
            left: 571, top: 391, width: this.RUNNER_CELLS_WIDTH,
            height: this.RUNNER_CELLS_HEIGHT
        },
        {
            left: 621, top: 391, width: this.RUNNER_CELLS_WIDTH,
            height: this.RUNNER_CELLS_HEIGHT
        },
        {
            left: 671, top: 391, width: this.RUNNER_CELLS_WIDTH,
            height: this.RUNNER_CELLS_HEIGHT
        },
        {
            left: 721, top: 391, width: this.RUNNER_CELLS_WIDTH,
            height: this.RUNNER_CELLS_HEIGHT
        },
        {
            left: 771, top: 391, width: this.RUNNER_CELLS_WIDTH,
            height: this.RUNNER_CELLS_HEIGHT
        },
        {
            left: 821, top: 391, width: this.RUNNER_CELLS_WIDTH,
            height: this.RUNNER_CELLS_HEIGHT
        },
    ],
        ...
        this.runnerCellsLeft = [
            {
                left: 471, top: 306, width: this.RUNNER_CELLS_WIDTH,
                height: this.RUNNER_CELLS_HEIGHT
            },
            {
                left: 521, top: 306, width: this.RUNNER_CELLS_WIDTH,
                height: this.RUNNER_CELLS_HEIGHT
            },
            {
                left: 571, top: 306, width: this.RUNNER_CELLS_WIDTH,
                height: this.RUNNER_CELLS_HEIGHT
            },
            {
                left: 621, top: 306, width: this.RUNNER_CELLS_WIDTH,
                height: this.RUNNER_CELLS_HEIGHT
            },
            {
                left: 671, top: 306, width: this.RUNNER_CELLS_WIDTH,
                height: this.RUNNER_CELLS_HEIGHT
            },
            {
                left: 721, top: 306, width: this.RUNNER_CELLS_WIDTH,
                height: this.RUNNER_CELLS_HEIGHT
            },
            {
                left: 771, top: 306, width: this.RUNNER_CELLS_WIDTH,
                height: this.RUNNER_CELLS_HEIGHT
            },
            {
                left: 821, top: 306, width: this.RUNNER_CELLS_WIDTH,
                height: this.RUNNER_CELLS_HEIGHT
            },
        ],
    ...
    this.runBehavior = {
        ...
        execute: function (sprite,
            ...
            let runnerRight = sprite.left + snailBait.RUNNER_CELLS_WIDTH;
            let runnerBottom = sprite.top + snailBait.RUNNER_CELLS_HEIGHT;  // We have to use the cells because the width and height aren't set for the runner sprite object
            let runnerOnPlatform = false;

            if (sprite.runAnimationRate === 0) {
                return;
            }

            for (let i = 0; i < snailBait.platforms.length; ++i) {
                let platform = snailBait.platforms[i];
                let platformLeft = platform.left - platform.hOffset;
                let platformRight = platformLeft + platform.width;
                let platformBottom = platform.top + platform.height;

                if((runnerBottom >= platform.top && runnerBottom <= platformBottom) && (runnerRight > platformLeft && sprite.left < platformRight)) {
                    runnerOnPlatform = true;
                    break;
                }
            }
