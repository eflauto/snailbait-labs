var SnailBait = function () {
    ...
    this.FLOUR_CELLS_HEIGHT = 50;
    this.FLOUR_CELLS_WIDTH = 50;
    ...
    this.flourBagCells = [
        {
            left: 471, top: 306, width: this.FLOUR_CELLS_WIDTH,
            height: this.FLOUR_CELLS_HEIGHT
        },
        {
            left: 521, top: 306, width: this.FLOUR_CELLS_WIDTH,
            height: this.FLOUR_CELLS_HEIGHT
        },
        {
            left: 571, top: 306, width: this.FLOUR_CELLS_WIDTH,
            height: this.FLOUR_CELLS_HEIGHT
        },
        {
            left: 621, top: 306, width: this.FLOUR_CELLS_WIDTH,
            height: this.FLOUR_CELLS_HEIGHT
        },
        {
            left: 671, top: 306, width: this.FLOUR_CELLS_WIDTH,
            height: this.FLOUR_CELLS_HEIGHT
        },
        {
            left: 721, top: 306, width: this.FLOUR_CELLS_WIDTH,
            height: this.FLOUR_CELLS_HEIGHT
        },
        {
            left: 771, top: 306, width: this.FLOUR_CELLS_WIDTH,
            height: this.FLOUR_CELLS_HEIGHT
        },
        {
            left: 821, top: 306, width: this.FLOUR_CELLS_WIDTH,
            height: this.FLOUR_CELLS_HEIGHT
        },
    ]
    ...
    this.flourBagData = [
        {
            left: 305,
            top: this.TRACK_2_BASELINE - this.FLOUR_CELLS_HEIGHT
        },
    ]
...
SnailBait.prototype = {
    ...
    addSpritesToSpriteArray: function () {
        ...
        for (var i = 0; i < this.flourBags.length; ++i) {
            this.sprites.push(this.flourBags[i]);
        }
    ...
    initializeSprites: function () {
        ...
        this.positionSprites(this.flourBags, this.flourBagData);
    },
    ...
    createFlourBagSprites: function () {
        var flourBag,
            flourBagArtist = new SpriteSheetArtist(this.spritesheet,
                this.flourBagCells);

        for (var i = 0; i < this.flourBagData.length; ++i) {
            flourBag = new Sprite('flourBag', flourBagArtist);

            flourBag.width = this.FLOUR_CELLS_WIDTH;
            flourBag.height = this.FLOUR_CELLS_HEIGHT;

            this.flourBags.push(flourBag);
        }
    },
