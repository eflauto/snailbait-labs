...
SnailBait.prototype = {
    ...
    createBatSprites: function () {
        ...
        for (var i = 0; i < this.batData.length; ++i) {
            ...
            bat.collisionMargin = {
                left: 10, top: 20, right: 10, bottom: 26,
            };
    ...
    createBeeSprites: function () {
        ...
        for (var i = 0; i < this.beeData.length; ++i) {
            ...
            bee.collisionMargin = {
                left: 15, top: 20, right: 5, bottom: 30,
            };
    ...
    createCoinSprites: function () {
        ...
        for (var i = 0; i < this.coinData.length; ++i) {
            ...
            coin.collisionMargin = {
                left: coin.width / 8 - 6, top: coin.height / 8 - 6,
                right: coin.width / 8 - 4, bottom: coin.height / 4 - 10
            };
    ...
    createSapphireSprites: function () {
        ...
        for (var i = 0; i < this.sapphireData.length; ++i) {
            ...
            sapphire.collisionMargin = {
                left: sapphire.width / 8 - 2, top: sapphire.height / 8 - 4,
                right: sapphire.width / 8 - 6, bottom: sapphire.height / 4 - 10
            };
